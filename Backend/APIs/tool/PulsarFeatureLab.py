...
# Custom file Imports:
from . import Utilities, DataProcessor
import os
...
class PulsarFeatureLab:
    ...
    def main(self,argv=None,file_path=None):
        """
        ...
        args.dir=file_path
        args.out=os.path.join("temporary","output.csv")
        args.feature_type=6
...
def run(file_path):
    PulsarFeatureLab().main(file_path=file_path)
    return True